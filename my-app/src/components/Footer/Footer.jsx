          ...
          <div className="footer__top">
            <div className="footer__content">
                ...
                <div className="footer__socials-icons">
                  <a className="footer__socials-link" href="#!">
                    ...
                    >
                      <path
                        opacity="0.4"
                        d="M22 43.5C33.8741 43.5 43.5 33.8741 43.5 22C43.5 10.1259 33.8741 0.5 22 0.5C10.1259 0.5 0.5 10.1259 0.5 22C0.5 33.8741 10.1259 43.5 22 43.5Z"
                        stroke="white"
                      />
                      <path
                        fill-rule="evenodd"
              ...
              <div className="footer__location">
                <h3 className="footer__location-heading">Find us</h3>
                <div className="footer__wrap-address">
                  <div className="footer__address">
                    <h3 className="footer__address-heading">In USA</h3>
                  ...
                  <div className="footer__address">
                    <h3 className="footer__address-heading">In Argentina</h3>
                    <ul className="footer__address-list">
                      <li className="footer__address-item">
                  ...
                  <div className="footer__address">
                    <h3 className="footer__address-heading">In Poland</h3>
                    <ul className="footer__address-list">
                  ...
                  <div className="footer__address">
                    <h3 className="footer__address-heading">In Cyprus</h3>
                    <ul className="footer__address-list">
                      <li className="footer__address-item">
            ...
            <div className="footer__development">
              <div className="footer__fintech">
                <h3 className="footer__heading">Fintech</h3>
            ...
            <div className="footer__development">
              <h3 className="footer__heading">Expertise</h3>
              <ul className="footer__list">
